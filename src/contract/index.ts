...
export class Contract {
  ...
  async approve<R extends ResponseTypes = undefined>(
    {
      from,
      spender,
      amount,
  ...
  async authorized<R extends ResponseTypes = undefined>(
    { id }: { id: Address },
    options: {
      /**
       * The fee to pay for the transaction. Default: 100.
  ...
  async transfer<R extends ResponseTypes = undefined>(
    ...
    return await invoke({
      ...
      ...this.options,
      parseResultXdr: (xdr) => {
        return this.spec.funcResToNative("transfer", xdr);
      },
    });
  }

  async transferFrom<R extends ResponseTypes = undefined>(
    {
      spender,
      from,
      to,
  ...
  async burn<R extends ResponseTypes = undefined>(
  ...
  async burnFrom<R extends ResponseTypes = undefined>(
    {
      spender,
      from,
      amount,
  ...
  async clawback<R extends ResponseTypes = undefined>(
    { from, amount }: { from: Address; amount: i128 },
    options: {
      /**
       * The fee to pay for the transaction. Default: 100.
  ...
  async setAuthorized<R extends ResponseTypes = undefined>(
  ...
  async mint<R extends ResponseTypes = undefined>(
